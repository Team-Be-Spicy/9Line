...
public class CommandLineStartupRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        requestRepository.save(new Request(1L, "Osprey 1-2", "43SBR1999651017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Complete", format.parse("01-12-2021")));
        requestRepository.save(new Request(2L, null, "43SBR3999691017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Pending", format.parse("01-12-2021")));
        requestRepository.save(new Request(3L, "Osprey 3-4", "43SBR4999641017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Complete", format.parse("01-12-2021")));
        requestRepository.save(new Request(4L, "Osprey 3-4", "43SBR6999611017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Assigned", format.parse("01-12-2021")));
        requestRepository.save(new Request(5L, null, "43SBR8289621017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Pending", format.parse("01-12-2021")));
        requestRepository.save(new Request(6L, "Osprey 1-2", "43SBR1999651017", "53.80 ThunderStruck 2-1 A6B88", 1, 2, 3, 4, "Hoist", 1, 0, "VS 17 panel", "No enemy troops", "US/Coalition Military", "Nuclear", "Complete", format.parse("01-12-2021")));
